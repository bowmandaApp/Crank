...
export class HomeComponent {
  ...
  crank_images = [
    'Crank/src/assets/crank.png',
    'Crank/src/assets/crank2.png',
    'Crank/src/assets/crank3.png',
    'Crank/src/assets/crank4.png'
  ];
  currentIndex = 0;
  ...
  flywheel_images = [
    'Crank/src/assets/flywheel1.png',
    'Crank/src/assets/flywheel.gif',
  ];
  currentFlyIndex = 0;
